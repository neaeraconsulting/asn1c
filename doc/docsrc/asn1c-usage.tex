...
\setmainfont{PT Sans}
\setsansfont{PT Sans}
\IfFontExistsTF{Consolas}{\setmonofont{Consolas}}{\setmonofont{inconsolata}}
...
% Courier 10 Pitch
\IfFontExistsTF{Courier10 BT WGL4}{\def\courierFont{Courier10 BT WGL4}}{\def\courierFont{Courier Bold}}
\setmonofont[OpticalSize=10,Scale=1.05]{\courierFont}
\IfFontExistsTF{Cambria Math}{\setmathfont[Scale=1.05]{Cambria Math}}{\setmathfont[Scale=1.05]{PT Sans}}
...
{\ttfamily -fcompound-names-all} & {\small Prefix all generated source filenames with the module name.}\\
{\ttfamily -fcase-insensitive-filenames} & {\small Ensure generated source file names are unique in case-insensitive file systems. Use with -fcompound-names.}\\\\
